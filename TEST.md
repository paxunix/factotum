...
* Action:
  ...
  3. change the description rows and command code
  4. save the command
  5. export the bundle
* Expected:
  ...
  * Editable body fields include structured localized descriptions, code, help template, help strings JSON, optionsSpec JSON, and structured requires rows
...
* Expected:
  ...
  * The sort selector supports Modified time, Name, and ID, defaults to ascending Name order, and has a visible direction-toggle icon.
