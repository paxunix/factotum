...
M4. Replace the remaining JSON textareas with friendlier structured editors over time for help strings, optionsSpec, and requires. For localized text editors beyond Description, prefer a locale selector plus add-locale flow over raw JSON editing.
